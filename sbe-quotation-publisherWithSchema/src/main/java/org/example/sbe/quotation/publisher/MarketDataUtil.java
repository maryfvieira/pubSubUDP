...
import org.example.sbe.quotation.model.stub.MessageHeaderEncoder;
import org.example.sbe.quotation.model.stub.TradeDataDecoder;
import org.example.sbe.quotation.model.stub.TradeDataEncoder;
...
public class MarketDataUtil {
    ...
    public static DirectBuffer encodeAndWrite(ByteBuffer buffer, MarketData marketData) {
